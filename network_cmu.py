...
class CmuNetwork(network_base.BaseNetwork):
    def setup(self):
        (self.feed('image')
             ...
             .conv(3, 3, 128, 1, 1, name='conv4_4_CPM')          # VGG feature input
             ...
             .conv(1, 1, 38, 1, 1, relu=False, name='conv5_5_CPM_L1'))  # Stage_1: L1
        ...
        (self.feed('conv4_4_CPM')
             ...
             .conv(1, 1, 19, 1, 1, relu=False, name='conv5_5_CPM_L2'))  # Stage_1: L2
